...
;(function(root, factory) {
    ...
    defaults = {
        ...
        urls: {
            ...
            youtube: {
                api:            'http://www.youtube.com/iframe_api'
            },
            soundcloud: {
        ...
        function _setupEmbed() {
            ...
            // Vimeo
                ...
                _setAttributes(vimeo, {
                    'src':                      'https://player.vimeo.com/video/' + mediaId + '?player_id=' + id + '&api=1&badge=0&byline=0&portrait=0&title=0&background=1&autoplay=0&loop=0',
                    'id':                       id,
                    'allowfullscreen':          '',
                    'frameborder':              0
                });
